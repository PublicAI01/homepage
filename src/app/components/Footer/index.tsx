...
const Footer = () => {
  return (
    <footer className="border-t border-b5 bg-b1 pt-5 md:pt-5">
      <div className="container relative mx-auto flex flex-col max-lg:w-[var(--mobile-container-width)]">
        ...
        <section className="my-2.5 flex w-full flex-col justify-between gap-2.5 md:flex-row md:items-center">
          <a
            ...
            className="flex w-min items-center self-stretch rounded-lg border border-b5 p-2 text-white md:px-4">
            <Mail className="size-4 text-primary md:size-6" />
            <p className="ml-2 text-base text-g1 md:text-xl">
              contact@publicai.io
            </p>
          </a>
          <address className="flex w-max items-center gap-2 rounded-lg border border-b5 p-2 md:px-4">
