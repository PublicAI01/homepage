      ...
      <dialog
        ...
        <article className="prose prose-sm bg-b2 prose-a:text-white prose-li:marker:text-red-500 rounded-xl border border-white/10 px-6 py-4 max-md:mx-4">
          ...
          <div className="text-xs font-medium text-white md:text-base">
            <b>
              Our X account @PublicAI_ has been compromised. DO NOT trust any
              messages posted by the @PublicAI_ account during this time.
            </b>
            <p>Specifically:</p>
            <ul>
              <li>DO NOT click on any links shared by the account.</li>
              <li>DO NOT purchase any tokens or CA promoted by the account.</li>
            </ul>
            <p>
              Our product and platform remain fully functional and secure. For
              updated communication while we recover our X please follow our
              backup X account, telegram, and discord:
            </p>
            <ul>
              <li>
                <a
