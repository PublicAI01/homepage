...
const Showcase = () => {
	return (
		<SectionWrapper
			...
			<h1 className="text-xl md:text-3xl font-bold text-center text-white mt-14">
				AI Agents for Public Blockchains
			</h1>
			<h2 className="mb-5 md:mb-10 text-base md:text-lg font-medium text-center text-white mt-7 md:px-[20%] px-4">
			...
			<h1 className="mt-16 md:mt-32 text-xl md:text-3xl font-bold text-center text-white">
