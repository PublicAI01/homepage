...
const Showcase = () => {
	return (
		<SectionWrapper
			className="lg:mt-40 bg-b3 py-7 lg:py-14"
			title="Showcase"
			useMobileContainerWidth={false}>
			<h3 className="text-xl lg:text-3xl font-bold text-center text-white mt-14">
			...
			<h3 className="mt-16 lg:mt-32 text-xl lg:text-3xl font-bold text-center text-white">
